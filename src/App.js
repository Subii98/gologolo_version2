...
class App extends Component {
  ...
  buildChangeLogoTransaction = (oldLogo, logoKey, newText, newTextColor, newFontSize, newBackgroundColor, newBorderColor, 
    ...
    let postEditLogo = {
      ...
      borderWidth: newborderThickness,
      padding: newPadding,
      margin : newMargin
    };
  ...
  makeNewLogo = () => {
    let newLogo = {
      ...
      borderType : LogoDefaults.BORDER_TYPE,
  ...
  afterLogoDeleted = () => {
    ...
    // FIRST GO HOME
    this.goToHomeScreen();
    let logoname = JSON.stringify(this.state.logos);
    localStorage.setItem("recent_work",logoname);
  }
